...
class _$DownloadsStateTearOff {
  ...
  _DownloadState call(
    ...
    return _DownloadState(
      isLoading: isLoading,
      downloads: downloads,
      downloadSuccessFailerOption: downloadSuccessFailerOption,
    );
  }
}
...
mixin _$DownloadsState {
  ...
  List<MDownloads> get downloads => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<MDownloads>>>
      get downloadSuccessFailerOption => throw _privateConstructorUsedError;
...
class _$DownloadsStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? downloadSuccessFailerOption = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      downloads: downloads == freezed
          ...
          : downloads // ignore: cast_nullable_to_non_nullable
              as List<MDownloads>,
      downloadSuccessFailerOption: downloadSuccessFailerOption == freezed
          ? _value.downloadSuccessFailerOption
          : downloadSuccessFailerOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainFailure, List<MDownloads>>>,
    ));
  }
}
...
class _$_DownloadState implements _DownloadState {
  const _$_DownloadState(
      ...
      required this.downloadSuccessFailerOption});

  @override
  final bool isLoading;
  @override
  final List<MDownloads> downloads;
  @override
  final Option<Either<MainFailure, List<MDownloads>>>
      downloadSuccessFailerOption;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadSuccessFailerOption: $downloadSuccessFailerOption)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other.downloadSuccessFailerOption,
                downloadSuccessFailerOption));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(downloadSuccessFailerOption));
...
abstract class _DownloadState implements DownloadsState {
  const factory _DownloadState(
      ...
      required List<MDownloads> downloads,
      required Option<Either<MainFailure, List<MDownloads>>>
          downloadSuccessFailerOption}) = _$_DownloadState;

  @override
  bool get isLoading;
  @override
  List<MDownloads> get downloads;
  @override
  Option<Either<MainFailure, List<MDownloads>>> get downloadSuccessFailerOption;
  @override
  @JsonKey(ignore: true)
  _$DownloadStateCopyWith<_DownloadState> get copyWith =>
      throw _privateConstructorUsedError;
